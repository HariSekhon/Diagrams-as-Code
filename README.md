...
Diagrams as Code using the awesome [D2](https://d2lang.com/) and Python [diagrams](https://github.com/mingrammer/diagrams) module.
...
Create any single D2 diagram and have it open automatically by running d2 against the file:

```shell
d2 opentsdb_kubernetes_hbase.d2
```
