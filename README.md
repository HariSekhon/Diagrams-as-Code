...
This is the only diagram not as code (here for historical interest). I would embed it as a live diagram but GitHub markdown doesn't allow HTML iframes to embed the live diagram so this is just a png.
